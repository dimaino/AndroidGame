...
public class PlatformFactory
{
	...
	public static final FixtureDef PLATFORM_FIXTURE = PhysicsFactory.createFixtureDef(0f, .01f, 1f, false);
	...
	public Platform createPlatform(float x, float y)
	{
		...
		Body platformBody = PhysicsFactory.createBoxBody(physicsWorld, centerX, centerY, platform.getWidth() - 20, 1, BodyType.KinematicBody, PLATFORM_FIXTURE);
